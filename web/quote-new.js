...
async function bootstrap() {
  ...
  document.querySelectorAll(".add-item-trigger").forEach((button) => button.addEventListener("click", () => {
    addItemRow({
      type: "hotel",
      currency: form.currency.value || meta.defaultItemCurrency || "EUR",
    });
